...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, IconModule, MatMenuModule, MatTooltipModule, FormsModule],
...
export class SearchBoxMultipleComponent implements OnInit {
  ...
  constructor(
    ...
    public iconServices: IconsService
  ) { 
